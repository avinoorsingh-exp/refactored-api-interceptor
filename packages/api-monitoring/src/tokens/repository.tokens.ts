/** Nest DI token for the API request log TypeORM repository. */
export const API_MONITORING_REQUEST_LOG_REPO = Symbol('API_MONITORING_REQUEST_LOG_REPO');
/** Nest DI token for the API route stats TypeORM repository. */
