...
export class InitialSchema1762356356157 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "core"."company" ("id" bigserial NOT NULL, "name" text NOT NULL, "email" text NOT NULL, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updated_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), CONSTRAINT "UQ_b0fc567cf51b1cf717a9e8046a1" UNIQUE ("email"), CONSTRAINT "PK_056f7854a7afdba7cbd6d45fc20" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "core"."company_external_reference" ("company_id" bigint NOT NULL, "external_reference_id" uuid NOT NULL, CONSTRAINT "PK_200241f196ec4223ba9ac05784f" PRIMARY KEY ("company_id", "external_reference_id"))`);
