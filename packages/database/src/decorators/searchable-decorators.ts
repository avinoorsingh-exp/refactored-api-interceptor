...
export interface SearchableOptions {
  ...
  /**
   * Custom validation function for search values
   * Use SearchValidators.integer, SearchValidators.bigint, or custom function
   * @example
   * @Searchable({ type: 'integer', validate: SearchValidators.integer })
   * countryId: number;
   */
