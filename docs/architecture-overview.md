...
**See:** [ADR-001: Database Entity Separation](./ADRs/001-database-entity-separation.md)
...
**See:** [ADR-002: Base and Expanded Schema Pattern](./ADRs/002-base-expanded-schema-pattern.md)
...
- [ADR-001: Database Entity Separation](./ADRs/001-database-entity-separation.md)
- [ADR-002: Base/Expanded Schema Pattern](./ADRs/002-base-expanded-schema-pattern.md)
