...
/**
 * AU Agent Details Agent Updated Consumer
 * 
 * Consumes messages from the AU_AgentDetails_AgentUpdated_V2 topic.
 * 
 ...
 */
@Injectable()
export class AuAgentDetailsAgentUpdatedConsumer implements RegisterableKafkaService {
	private readonly topic = 'AU_AgentDetails_AgentUpdated_V2';
	...
	/**
	 * Translate AU_AgentDetails_AgentUpdated_V2 Kafka message to database upsert format
	 */
